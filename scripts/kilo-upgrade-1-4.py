#!/usr/bin/env python
# UPGRADE SCRIPT for Juno to Kilo RPC f5
...
ADDEXTMON = (
    #Adds EXTERNAL MONITOR KILO to exisiting Pools
    r'modify ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_CINDER_API { monitor ' + PREFIX_NAME + '-MON-EXT-ENDPOINT-KILO }',
    r'modify ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_NOVA_API_OS_COMPUTE { monitor ' + PREFIX_NAME + '-MON-EXT-ENDPOINT-KILO }',
    r'modify ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_NEUTRON_SERVER { monitor ' + PREFIX_NAME + '-MON-EXT-ENDPOINT-KILO }',
    r'modify ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_KEYSTONE_SERVICE { monitor ' + PREFIX_NAME + '-MON-EXT-ENDPOINT-KILO }',
    r'modify ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_GLANCE_API { monitor ' + PREFIX_NAME + '-MON-EXT-ENDPOINT-KILO }',
    r'modify ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_GLANCE_REGISTRY { monitor ' + PREFIX_NAME + '-MON-EXT-ENDPOINT-KILO }',
    r'modify ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_HEAT_API { monitor ' + PREFIX_NAME + '-MON-EXT-ENDPOINT-KILO }',
    r'modify ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_SWIFT { monitor ' + PREFIX_NAME + '-MON-EXT-ENDPOINT-KILO }',
    r'modify ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_GALERA { monitor ' + PREFIX_NAME + '_MON_GALERA }''\n'
    )
CLEANUP = (
    #Fix Repo
    r'delete ltm virtual /' + PART + '/' + PREFIX_NAME + '_VS_REPO',
    r'delete ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_REPO',
    r'delete ltm monitor http /' + PART + '/' + PREFIX_NAME + '_MON_HTTP_REPO''\n',
    #Rename Spice to NovaConsole
    r'delete ltm virtual /' + PART + '/' + PREFIX_NAME + '_PUB_VS_NOVA_SPICE_CONSOLE',
    r'delete ltm virtual /' + PART + '/' + PREFIX_NAME + '_VS_NOVA_SPICE_CONSOLE',
    r'delete ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_NOVA_SPICE_CONSOLE',
    r'delete ltm monitor http /' + PART + '/' + PREFIX_NAME + '_MON_HTTP_NOVA_SPICE_CONSOLE''\n',
    #Delete EC2
    r'delete ltm virtual /' + PART + '/' + PREFIX_NAME + '_PUB_SSL_VS_NOVA_API_EC2',
    r'delete ltm virtual /' + PART + '/' + PREFIX_NAME + '_VS_NOVA_API_EC2',
    r'delete ltm pool /' + PART + '/' + PREFIX_NAME + '_POOL_NOVA_API_EC2',
    r'delete ltm monitor tcp /' + PART + '/' + PREFIX_NAME + '_MON_TCP_NOVA_API_EC2''\n'
)

MONITORS = [
    r'modify ltm monitor mysql /' + PART + '/' + PREFIX_NAME + '_MON_GALERA { username monitoring }',
    r'create ltm monitor http /' + PART + '/' + PREFIX_NAME + '_MON_HTTP_NOVA_CONSOLE {'
    r' defaults-from http destination *:6082 recv "200 OK" send "HEAD /spice_auto.html'
    r' HTTP/1.1\r\nHost: rpc\r\n\r\n" }',
    r'modify ltm monitor https /' + PART + '/' + PREFIX_NAME + '_MON_HTTPS_HORIZON_SSL { send'
